...
<form class="form-horizontal" method='post' action="{{path_for('embalage.storeStock')}}" autocomplete="off">
                ...
                <fieldset class="content-group">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label class="control-label col-lg-2">تاريخ</label>
                            <div class="col-lg-10">
                             <input type="text" class="form-control datepicker" name="dateofentree" placeholder="تاريخ" readonly="true">
                            </div>
                        </div> 
...
<form class="form-horizontal" method='post' action="{{path_for('stockGeneral.validateSortieList')}}" autocomplete="off">
...
<form class="form-horizontal" id='formSortieEmbalage' method='post' action="{{path_for('embalage.storeStockSortie')}}" autocomplete="off">

                <fieldset class="content-group" id="leeetch">
                    
                     <div class='show_meNumber' style='display:none;'>
                    
لديك :
                       <b class='ExistNumber' data-num=''></b>
                       من هذا المنتوج
                    ...
                    <br>
                        <div class="form-group">
                            <div class="col-lg-11">
                               <div class="product-q">
                                    <select class="form-control" name="productID" id='getSortieNumber' placeholder="produit" >
                ...
                <fieldset class="content-group" >
                    <div class="form-group">
  <div class="col-lg-11">
  <input type="text" class='form-control datepicker' name='dateofsortie' placeholder='تاريخ' readonly="true" />
    </div>
</div>
                ...
                <div class="text-right">
                    <button type="submit" class="btn btn-primary" id="onclickSendSortie">
                     تصدير المخزون
                        <i class="icon-arrow-left13 position-right"></i>
                    </button>
                </div>
